...
export function Footer() {
  ...
  return (
    <footer className="bg-[#96CEEA]">
      {/* Mobile: custom padding 20px horizontal, 15px vertical */}
            ...
            <div className="lg:max-w-[962px] lg:mx-auto">
                  ...
                  <ul className="space-y-1.5">
                    {quickLinks.map((link) => (
                      <li key={link.name}>
                        <Link
                          href={link.href}
                          className="text-sm text-gray-800 hover:text-gray-900 transition-colors font-serif"
                        >
                          {link.name}
                        </Link>
                      </li>
              ...
              <div className="hidden md:grid md:grid-cols-3 lg:grid-cols-[1fr_auto_auto_auto] gap-8 lg:gap-16">
                ...
                <div className="space-y-4 lg:max-w-[280px]">
                  <h3 className="text-2xl lg:text-[28px] font-serif text-gray-900">
                    LOTTI
                  </h3>
                ...
                {/* Quick Links */}
                <div>
                  <h4 className="text-sm font-semibold uppercase tracking-wider text-gray-900 mb-4 lg:mb-6">
                    {t('quickLinks')}
                  </h4>
                  <ul className="space-y-2 lg:space-y-3">
                    {quickLinks.map((link) => (
                      <li key={link.name}>
                        <Link
                          href={link.href}
                          className="text-base text-gray-800 hover:text-gray-900 transition-colors font-serif"
                        >
                          {link.name}
                        </Link>
                      </li>
                ...
                <div className="hidden lg:block">
                  <h4 className="text-sm font-semibold uppercase tracking-wider text-gray-900 mb-6">
                    {t('legal.title')}
                  </h4>
